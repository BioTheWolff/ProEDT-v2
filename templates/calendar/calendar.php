...
$this->layout('calendar/_template') ?>
...
<v-main>
  <v-container>
    ...
    <v-alert dense text type="success">
      Nouvelle version disponible ! Si vous avez des idées ou des soucis, n'hésitez pas à nous <a href="/about">contacter</a>.<br>
      Les <strong>devoirs et informations importantes</strong> arrivent très prochainement.
    </v-alert>
  </v-container>
</v-main>